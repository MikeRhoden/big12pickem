...
if request.QueryString("t")="1" then
    qst=1
elseif request.QueryString("w")=1 and now()<cdate("9/3/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=2 and now()<cdate("9/10/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=3 and now()<cdate("9/17/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=4 and now()<cdate("9/24/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=5 and now()<cdate("10/1/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=6 and now()<cdate("10/8/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=7 and now()<cdate("10/15/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=8 and now()<cdate("10/22/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=9 and now()<cdate("10/29/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=10 and now()<cdate("11/5/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=11 and now()<cdate("11/12/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=12 and now()<cdate("11/19/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=13 and now()<cdate("11/26/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=14 and now()<cdate("12/3/2016 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=15 and now()<cdate("12/10/2016 10:59:59 AM") then
    response.Redirect("home.asp")
end if
%>
