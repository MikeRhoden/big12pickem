...
Function WriteGame(no, vis, visitor, ho, home, fav, line, min, max, note)
	dim rv
...
<table border=0 width=100%>
	...
	<td align="left"><span class="warning">Once you submit your picks you can come back here & edit your picks until Saturday @ <%=getEndTime%> </span></td>
	</tr>
</table>
...
''	Dim picks, values, games(20), vis(20), visitors(20), hos(20), homes(20), favs(20), lines(20), mins(20), maxs(20)
 %>
		...
		<%= WriteGame(g.GetGame(i), g.GetVis(i), g.GetVisitor(i), g.GetHo(i), g.GetHome(i), g.GetFav(i), g.GetLine(i), g.GetMin(i), g.GetMax(i), g.GetNote(i)) %>
<% Next %>
	</table></td>
