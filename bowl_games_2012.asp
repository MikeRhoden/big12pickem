...
<form name="games" method=post action="postbowlgames_2012.asp?uid=<%=uid%>" onSubmit="return verify(this)">
...
<table border=0 width=100%>
	...
	<td align="left"><span class="warning">Once you submit your picks you can come back here & edit your picks until JAN 1 @ NOON </span></td>
	</tr>
</table>
		...
		<table border="0" cellpadding="0" cellspacing="3">
			<tr>
				<td align="center" valign="top" class="sec">
					...
					<tr><td>	
					<table border=1 cellpadding=3 cellspacing=0 align=center bgcolor="#FFFFFF">
						<tr><td colspan="2" class="priority">BCS Bowls <br />(-orange+cotton)</td></tr>
						<tr>
							<th align="center">Matchup&nbsp;&nbsp;</th>
				...
				</td><td ><img src="../gtm/images/spacer.gif" width="16" height="1"></td>
...
<%
	If Not toolate Then
%>
			Click Button to <input type=submit value="Make Picks"<% if now()>cdate("1/1/2013  11:59:59 AM") then %>disabled="disabled" <% end if%> />
			<%
	Else
%>
