...
<%
	Function GetUsers(wk)
		...
		rs.Open "Select Distinct pkmUsers.UID, Last_Name, First_Name, Week_Score_2 From pkmUsers, pkmPicks Where pkmUsers.UID = pkmPicks.UID And Week = '" & wk & "' Order By Week_Score_2 DESC, Last_Name, First_Name ASC"
