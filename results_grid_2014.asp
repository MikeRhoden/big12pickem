...
if request.QueryString("t")="1" then
    qst=1
elseif request.QueryString("w")=1 and now()<cdate("9/6/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=2 and now()<cdate("9/13/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=3 and now()<cdate("9/20/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=4 and now()<cdate("9/27/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=5 and now()<cdate("10/4/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=6 and now()<cdate("10/11/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=7 and now()<cdate("10/18/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=8 and now()<cdate("10/25/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=9 and now()<cdate("11/1/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=10 and now()<cdate("11/8/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=11 and now()<cdate("11/15/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=12 and now()<cdate("11/22/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=13 and now()<cdate("11/29/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=14 and now()<cdate("12/6/2014 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=15 and now()<cdate("12/13/2014 10:59:59 AM") then
    response.Redirect("home.asp")
end if
%>
