...
<!-- #include file="cClasses06_bowls.asp" --->
<html>
<head>
<!-- #include file="funcs.asp" --->
<%
	Dim week, g, u, users, bg, pick_style, val_style, i, j, cnPick, correct, correct_style, total_style, y
	y = 2006
	week = 14 'Request.Form("week")
...
<%
	Function GetUsers(wk,yr)
		...
		rs.Open "Select Distinct pkmUsers.UID, Last_Name, First_Name, Week_Score_2006_" & wk & " From pkmUsers, pkmPicks Where pkmUsers.UID = pkmPicks.UID And Week = '" & wk & "' AND Year = '" & yr & "' Order By Week_Score_2006_" & wk & " DESC, Last_Name, First_Name ASC"
...
<table border="1" cellpadding="1" cellspacing="0" align="center">
	<tr>
		<td align="center" valign="middle" class="grid_hdr">&nbsp;</td>
...
<%For i = 0 to UBound(users) - 1
		...
		Else
			bg = "#ffffff"
		End If
		If u.Week_Credits > 450 Then
			total_style = "value_total_pos"
		ElseIf u.Week_Credits < 450 Then
