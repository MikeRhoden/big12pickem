...
if request.QueryString("t")="1" then
    qst=1
elseif request.QueryString("w")=12 and now()<cdate("11/17/2012 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=13 and now()<cdate("11/24/2012 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=14 and now()<cdate("12/1/2012 10:59:59 AM") then
    response.Redirect("home.asp")
end if
%>
