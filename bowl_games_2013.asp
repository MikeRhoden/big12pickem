...
<form name="games" method=post action="postbowlgames_2013.asp?uid=<%=uid%>" onSubmit="return verify(this)">
...
<%
	If Not toolate Then
%>
			Click Button to <input type=submit value="Make Picks"<% if now()>cdate("1/1/2014  11:59:59 AM") then %>disabled="disabled" <% end if%> />
			<%
	Else
%>
