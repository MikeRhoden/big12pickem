...
if request.QueryString("t")="1" then
    qst=1
elseif request.QueryString("w")=1 and now()<cdate("9/5/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=2 and now()<cdate("9/12/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=3 and now()<cdate("9/19/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=4 and now()<cdate("9/26/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=5 and now()<cdate("10/3/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=6 and now()<cdate("10/10/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=7 and now()<cdate("10/17/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=8 and now()<cdate("10/24/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=9 and now()<cdate("10/31/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=10 and now()<cdate("11/7/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=11 and now()<cdate("11/14/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=12 and now()<cdate("11/21/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=13 and now()<cdate("11/28/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=14 and now()<cdate("12/5/2015 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=15 and now()<cdate("12/12/2015 10:59:59 AM") then
    response.Redirect("home.asp")
end if
%>
