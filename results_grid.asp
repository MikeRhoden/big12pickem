...
<%
	Function GetUsers(wk)
		...
		rs.Open "Select Distinct pkmUsers.UID, Last_Name, First_Name, Week_Score From pkmUsers, pkmPicks Where pkmUsers.UID = pkmPicks.UID And Week = '" & wk & "' Order By Week_Score DESC, Last_Name, First_Name ASC"
