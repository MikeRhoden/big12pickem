...
<form name="games" method=post action="postbowlgames_2011.asp?uid=<%=uid%>" onSubmit="return verify(this)">
...
<table border=0 width=100%>
	...
	<td align="left"><span class="warning">Once you submit your picks you can come back here & edit your picks until JAN 2 @ NOON </span></td>
	</tr>
</table>
