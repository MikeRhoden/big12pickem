...
<%
	...
	max_credits = 660
	If Request.QueryString("toolate") = "yes" or now()>cdate("1/11/2016 07:00:00 PM") Then
		toolate = true
	End If
	Set g = new cGames
	g.Initialize week, y
...
<body bgcolor="#FFFFFF">
<form name="games" method=post action="postbowlgames_2015.asp?uid=<%=uid%>" >
...
<table border=0 width=100%>
	...
	<td align="left"><span class="warning">Once you submit your picks you can come back here & edit your picks until 1/11/2016 07:00:00 PM </span></td>
	</tr>
</table>
