...
<!-- #include file="cClasses07_bowls.asp" --->
<html>
<head>
...
<%For i = 0 to g.Game_Count	- 1%>
		<td align="left" valign="top">
			<span class="vis_grid"><%=g.GetVis(i)%>[<%=g.Get_Pick_Count(0,(i+1))%>]</span><br>
			<span class="ho_grid"><%=g.GetHo(i)%>[<%=g.Get_Pick_Count(1,(i+1))%>]</span>
		</td>
<%Next%>
	</tr>
<%For i = 0 to UBound(users) - 1
