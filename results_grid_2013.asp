...
if request.QueryString("t")="1" then
    qst=1
elseif request.QueryString("w")=1 and now()<cdate("8/31/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=2 and now()<cdate("9/7/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=3 and now()<cdate("9/14/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=4 and now()<cdate("9/21/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=5 and now()<cdate("9/28/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=6 and now()<cdate("10/5/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=7 and now()<cdate("10/12/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=8 and now()<cdate("10/19/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=9 and now()<cdate("10/26/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=10 and now()<cdate("11/2/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=11 and now()<cdate("11/9/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=12 and now()<cdate("11/16/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=13 and now()<cdate("11/23/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=14 and now()<cdate("11/30/2013 10:59:59 AM") then
    response.Redirect("home.asp")
elseif request.QueryString("w")=15 and now()<cdate("12/7/2013 10:59:59 AM") then
    response.Redirect("home.asp")
end if
%>
